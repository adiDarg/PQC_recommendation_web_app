    ...
    return (
        <div className="pqc-container">
            ...
            <p className="pqc-description">
                Evaluate your financial application's operational constraints to determine the optimal post-quantum
                algorithms for your infrastructure.
            </p>
            ...
            The engine maps your parameters against PQC performance profiles to recommend a dual-component cryptographic blueprint:
                    ...
                    <ul className="pqc-sub-list">
                        <li className="pqc-sub-list-item">
                            <strong className="pqc-highlight">Key Encapsulation Mechanism (KEM):</strong> Optimized for
                            secure key exchange and forward secrecy.
                        </li>
                        <li className="pqc-sub-list-item">
                            <strong className="pqc-highlight">Digital Signature Algorithm (DSA):</strong> Tailored for
                            high-integrity identity verification and non-repudiation.
                        </li>
                    </ul>
                </li>
            </ol>
